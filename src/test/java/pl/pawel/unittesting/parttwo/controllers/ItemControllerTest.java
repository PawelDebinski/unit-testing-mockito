...
@WebMvcTest(ItemController.class) // załaduje tylko tą klasę, inne np. service nie będą dostępne i trzeba je mockować
public class ItemControllerTest {
    ...
    public void itemFromBusinessService_basic() throws Exception {
        when(businessService.retrieveHardcodedItem()).thenReturn(new Item(2,"Item2", 10, 20));
        ...
        MvcResult result = mockMvc.perform(request)
                .andExpect(status().isOk())
                .andExpect(content().json("{id:2,name:Item2,price:10,quantity:20}"))
                .andReturn();
    }
